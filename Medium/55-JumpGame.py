...
class Solution:
    def canJump(self, nums: List[int]) -> bool:
        # Approach: At any point calculate the maximum reachable point(i.e index) is possible.
        # If ever our index cross the maximum reachable point, it is not possible to reach last index.
        max_reach = 0
